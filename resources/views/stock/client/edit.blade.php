...
<div class="container">
    ...
    <div class="alert alert-danger">{{ $message }}</div>
    @enderror
    <form action="{{ route('clients.update', $client->client_id) }}" method="post" class="form">
        @csrf
        @method('PUT')
        ...
        <div class="form-group" style="max-width:50%">
            ...
            <input type="text" class="form-control" id="shipping_mark" name="shipping_mark" value="{{$client->shipping_mark}}" required>
        </div>
